    ...
    <div class="container">
        <div class="menu" style="background:#EED971">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-settings  menu-active menu-icon-settings-active" style="background:#EED971">
        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <td width="13%" >
                    <a href="settings.php" ><button  class="login-btn btn-secondary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <center>
                        <table class="filter-container" style="padding-bottom:30px;border: 2px solid blue;width:90%;height:10vh; background:#317773; color:white;" border="0">
                            <tr>
                                <td colspan="4">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex; color:white">
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex; color:#fff">
